...
var app = (function () {
    ...
    /* src/ListView.svelte generated by Svelte v3.43.0 */
    const file$1 = "src/ListView.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Move image view";
    			t5 = space();
    			p = element("p");
    			p.textContent = "this is list View";
    			add_location(h1, file$1, 6, 1, 118);
    			attr_dev(button, "text", "");
    			add_location(button, file$1, 8, 8, 160);
    			add_location(div, file$1, 7, 4, 146);
    			add_location(p, file$1, 10, 1, 241);
    			add_location(main, file$1, 5, 0, 110);
    		},
    		l: function claim(nodes) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => push("/img");

    	$$self.$$set = $$props => {
    		if ('title' in $$props) $$invalidate(0, title = $$props.title);
    	};

    	$$self.$capture_state = () => ({ push, title });
    ...
    /* src/ImageView.svelte generated by Svelte v3.43.0 */
    const file = "src/ImageView.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			button = element("button");
    			button.textContent = "Move List view";
    			t5 = space();
    			image = svg_element("image");
    			add_location(h1, file, 6, 1, 120);
    			attr_dev(button, "text", "");
    			add_location(button, file, 8, 8, 162);
    			add_location(div, file, 7, 4, 148);
    			attr_dev(image, "src", "https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png");
    			attr_dev(image, "alt", "image");
    			add_location(image, file, 10, 1, 239);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { title = 'Image View' } = $$props;
    	const writable_props = ['title'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ImageView> was created with unknown prop '${key}'`);
    	});
